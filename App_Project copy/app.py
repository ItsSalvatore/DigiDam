...
def view_scrummasters():
    ...
    scrummasters_2022 = get_scrummasters_2022
    ...
    return render_template('index.html', data=data, scrummasters_2022=scrummasters_2022, scrummasters_2024=scrummasters_2024, agilecoaches_2024=agilecoaches_2024,productowners_2024=productowners_2024,RTE_2019=RTE_2024,ATE_2024=ATE_2024,projectmanager_2024=projectmanager_2024,PMO_2024=PMO_2024,PGM_2024=PGM_2024)

# definitieve test.

# functie om het aantal scrummasters in 2022 op te halen
def get_scrummasters_2022():
    query = """SELECT COUNT(*)
               FROM medewerkers
               WHERE einddatum_contract BETWEEN '1980-01-01' AND '2010-12-31'
